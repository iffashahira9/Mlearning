...
public class quiz_age_6 extends AppCompatActivity {
    private TextView questions,questionAge6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_age6);
        ...
        questionAge6 = findViewById(R.id.questionAge6);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                questionAge6.setText(quesLists.get(currentQuestionPosition).getQuestion());
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedOptionByUser.isEmpty()){
                    Toast.makeText(quiz_age_6.this, "please choose answer", Toast.LENGTH_SHORT).show();
                }
                else{
                    nextQuestion();
                }
    ...
    private void nextQuestion (){
        ...
        if(currentQuestionPosition < quesLists.size()){
            ...
            Intent intent = new Intent(quiz_age_6.this, scoreaboardAge6.class);
           ...
           @Override
            public void run() {
                ...
                if(timeinMinute==1){
                    ...
                    Intent intent = new Intent(quiz_age_6.this, scoreboard.class);
                    intent.putExtra("correct", getCorrectAns());
                    intent.putExtra("incorrect", getWrongAns());
                    startActivity(intent);
